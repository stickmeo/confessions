<template>
    ...
    <side-bar>
        <template slot="links">
        <sidebar-link to="/admin/dashboard" name="Thống kê" icon="ti-panel"/>
        <sidebar-link to="/admin/pending" name="Chưa Duyệt" icon="ti-package"/>
        <sidebar-link to="/admin/approved" name="Đã Duyệt" icon="ti-heart"/>
        ...
        <sidebar-link to="/admin/typography" name="Typography" icon="ti-text"/>
